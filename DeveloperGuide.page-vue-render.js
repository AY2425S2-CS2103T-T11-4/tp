...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Dealing with missing/corrupted data files")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("_Prerequisite : Requires a copy of working finclient.json")])]),_v(" "),_c('li',[_c('p',[_v("Test case: Replace finclient.json with a corrupted file by editing the data to be in an incorrect format."),_c('br'),_v("\nExpected: App should still be able to start, however, the data will be corrupted and no contacts will be shown.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: Delete finclient.json "),_c('br'),_v("\nExpected: App should be repopulated with a copy of sample data and work again, without any presence of old data and a fresh copy of finclient.json is saved.")])])])])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{staticClass:"no-style",attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Thu, 3 Apr 2025, 17:03:48 GMT+8]")])])])}
}];
