...
with(this){return _c('figcaption',[_c('strong',[_v("Figure 18:")]),_v(" Undo Sequence Diagram (Logic).")])}
},function anonymous(
) {
...
with(this){return _c('figcaption',[_c('strong',[_v("Figure 19:")]),_v(" Undo Sequence Diagram (Model).")])}
},function anonymous(
) {
...
with(this){return _c('figcaption',[_c('strong',[_v("Figure 20:")]),_v(" UndoRedo State 4.")])}
},function anonymous(
) {
...
with(this){return _c('figcaption',[_c('strong',[_v("Figure 21:")]),_v(" UndoRedo State 5.")])}
},function anonymous(
) {
with(this){return _c('figcaption',[_c('strong',[_v("Figure 22:")]),_v(" Commit Activity Diagram.")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Initial launch.\n"),_c('ol',[_c('li',[_v("Download the jar file and copy into an empty folder.")]),_v(" "),_c('li',[_v("Open a terminal and navigate to the folder with the downloaded jar file.")]),_v(" "),_c('li',[_v("Run the jar file by typing the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java -jar finclient.jar")]),_v(" into the terminal.")]),_v(" "),_c('li',[_v("Expected: Shows the GUI with a set of sample contacts. The window size may not be optimum.\n"),_c('br'),_c('br')])])]),_v(" "),_c('li',[_v("Saving window preferences.\n"),_c('ol',[_c('li',[_v("Resize the window to an optimum size. Move the window to a different location. Close the window.")]),_v(" "),_c('li',[_v("Re-launch the app by typing the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java -jar finclient.jar")]),_v(" into the terminal. "),_c('br'),_v("\nExpected: The most recent window size and location is retained.\n"),_c('br'),_c('br')])])]),_v(" "),_c('li',[_v("Missing data on startup.\n"),_c('ol',[_c('li',[_v("Delete finclient.json located in /data/.")]),_v(" "),_c('li',[_v("Re-launch the app. "),_c('br'),_v("\nExpected: App should be repopulated with default values and work again.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Editing a person while all persons are being shown.\n"),_c('ol',[_c('li',[_v("Prerequisites: List all persons using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. There is at least 1 person in the list.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 e/newalice@example.com p/99887766")]),_v(" "),_c('br'),_v("Expected: The email and phone number for the first contact are updated accordingly.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 0 e/newalice@example.com p/99887766")]),_c('br'),_v("\nExpected: No person is edited. Error details shown in the status message.")]),_v(" "),_c('li',[_v("Other incorrect delete commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is larger than the list size)."),_c('br'),_v("\nExpected: Similar to previous.\n"),_c('br'),_c('br')])])]),_v(" "),_c('li',[_v("Removing optional fields.\n"),_c('ol',[_c('li',[_v("Prerequisites: List all persons using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. There is at least 1 person with the optional fields in the contact.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 c/delete")]),_v(" "),_c('br'),_v("Expected: The company field for the first contact is removed.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 j/delete")]),_v(" "),_c('br'),_v("Expected: The job field for the first contact is removed.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 s/delete")]),_v(" "),_c('br'),_v("Expected: The stock platform field for the first contact is removed.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 $/delete")]),_v(" "),_c('br'),_v("Expected: The net worth field for the first contact is removed.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 r/")]),_v(" "),_c('br'),_v("Expected: The remark for the first contact is removed.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 t/")]),_v(" "),_c('br'),_v("Expected: All tags for the first contact is removed.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 r/ t/ c/delete j/delete s/delete $/delete")]),_v(" "),_c('br'),_v("Expected: All optional fields are removed.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Searching by name\n"),_c('ol',[_c('li',[_v("Prerequisite: One contact with the name \"Alice Tan\" exists in FinClient.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find Alice")]),_c('br'),_v("\nExpected: Contacts matching the search criteria are displayed. If no match is found, an empty list is shown.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find Tan Alice")]),_c('br'),_v("\nExpected: The contact \"Alice Tan\" is returned regardless of the keyword order.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Listing all contacts\n"),_c('ol',[_c('li',[_v("Prerequisite: Have at least one contact in the FinClient")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_c('br'),_v("\nExpected: All contacts are displayed.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Hiding all contacts\n"),_c('ol',[_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("hide all")]),_c('br'),_v("\nExpected: All contacts’ details (e.g., phone numbers, emails, addresses, etc.) should be hidden from the contact list view. Only minimal information (like names) is visible.")])])]),_v(" "),_c('li',[_v("Hiding a specific contact by index\n"),_c('ol',[_c('li',[_v("Prerequisite: Have at least one contact in the FinClient")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("hide 1")]),_c('br'),_v("\nExpected: The contact at index 1 is hidden. The contact list should reflect this change.")])])]),_v(" "),_c('li',[_v("Hiding contacts by matching name keywords\n"),_c('ol',[_c('li',[_v("Prerequisite: There should be contacts whose names include “alice” or “bob”.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("hide alice bob")]),_c('br'),_v("\nExpected: All contacts with names matching the keyword \"alice\" or \"bob\" are hidden. The contact list should reflect this change.")])])]),_v(" "),_c('li',[_v("Revealing all contacts\n"),_c('ol',[_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("reveal all")]),_c('br'),_v("\nExpected: All hidden contacts’ details are revealed in the contact list view.")])])]),_v(" "),_c('li',[_v("Revealing a specific contact by index\n"),_c('ol',[_c('li',[_v("Prerequisite: Have at least two contacts in the FinClient and the second one is hidden.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("reveal 2")]),_c('br'),_v("\nExpected: The contact at index 2 is revealed. The contact list should reflect this change.")])])]),_v(" "),_c('li',[_v("Revealing contacts by matching name keywords\n"),_c('ol',[_c('li',[_v("Prerequisite: There should be contacts whose names include “charlie”.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("reveal charlie")]),_c('br'),_v("\nExpected: All contacts with names matching the keyword \"charlie\" are revealed. The contact list should reflect this change.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Sample Orders for 6 Contacts\n"),_c('ol',[_c('li',[_v("Prerequisite: Have at least six contacts in FinClient. Besides the six contacts, other contacts have no orders.")]),_v(" "),_c('li',[_v("Test case:"),_c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("order 1 o/BUY am/100 at/10.00\n")]),_c('span',[_v("order 2 o/BUY am/150 at/10.00\n")]),_c('span',[_v("order 3 o/SELL am/120 at/10.20\n")]),_c('span',[_v("order 4 o/SELL am/130 at/10.00\n")]),_c('span',[_v("order 5 o/BUY am/80 at/10.10\n")]),_c('span',[_v("order 6 o/SELL am/100 at/9.90\n")])])]),_v("Expected: The orders are successfully added to the respective contacts. The call auction clearing price is calculated based on the aggregated orders.")]),_v(" "),_c('li',[_v("Expected Call Auction Clearing Price Calculation\n"),_c('ol',[_c('li',[_v("Aggregated BUY Orders:")])]),_v(" "),_c('ul',[_c('li',[_v("Person 1: 100 shares at 10.00")]),_v(" "),_c('li',[_v("Person 2: 150 shares at 10.00")]),_v(" "),_c('li',[_v("Person 5: 80 shares at 10.10")]),_v(" "),_c('li',[_v("Total Buy Volume: 330 shares (only orders with a limit price ≥ clearing price will be valid)")])]),_v(" "),_c('ol',{attrs:{"start":"2"}},[_c('li',[_v("Aggregated SELL Orders:")])]),_v(" "),_c('ul',[_c('li',[_v("Person 3: 120 shares at 10.20 (only valid if the clearing price is ≥ 10.20, which may not be optimal)")]),_v(" "),_c('li',[_v("Person 4: 130 shares at 10.00")]),_v(" "),_c('li',[_v("Person 6: 100 shares at 9.90")]),_v(" "),_c('li',[_v("Total Sell Volume (at clearing price = 10.00):\n"),_c('ul',[_c('li',[_v("Person 4: 130 shares (10.00 ≤ 10.00)")]),_v(" "),_c('li',[_v("Person 6: 100 shares (9.90 ≤ 10.00)")]),_v(" "),_c('li',[_v("Total: 230 shares")])])])]),_v(" "),_c('ol',{attrs:{"start":"3"}},[_c('li',[_v("Clearing Price Determination:\nWhen evaluating candidate prices:")])]),_v(" "),_c('ul',[_c('li',[_v("At 10.00:\n"),_c('ul',[_c('li',[_v("Valid BUY orders: Persons 1, 2, and 5 (all with prices ≥ 10.00) contribute a total of 330 shares.")]),_v(" "),_c('li',[_v("Valid SELL orders: Persons 4 and 6 (with prices ≤ 10.00) contribute a total of 230 shares.")]),_v(" "),_c('li',[_v("Executed Volume: The trade can occur for min(330, 230) = 230 shares.")])])]),_v(" "),_c('li',[_v("At other candidate prices (for example, 9.90 or 10.10), the executed volume is lower.")])]),_v(" "),_c('ol',{attrs:{"start":"4"}},[_c('li',[_v("Final Expected Outcome:\nThe system should calculate the call auction clearing price as 10.00 with an executed trade volume of 230 shares. The status message should confirm that the order was generated successfully and reflect this clearing price calculation.")])])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Sorting Contacts\n"),_c('ol',[_c('li',[_v("Prerequisite: Have at least two contacts in FinClient.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort name")]),_c('br'),_v("\nExpected: Contacts are sorted alphabetically by name.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort networth")]),_c('br'),_v("\nExpected: Contacts are sorted according to their networth.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Clearing all contacts\n"),_c('ol',[_c('li',[_v("Prerequisite: Have at least one contact in the FinClient")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear")]),_c('br'),_v("\nExpected: All contacts are deleted, and a status message confirms the deletion.")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{staticClass:"no-style",attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Fri, 2 May 2025, 23:01:16 GMT+8]")])])])}
}];
